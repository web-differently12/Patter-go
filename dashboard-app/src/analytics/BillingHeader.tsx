    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-zinc-800/80 pb-5 font-sans">
      <div>
        <div className="flex items-center gap-2.5">
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-100">Facturation & Billing</h1>
        ...
        <p className="text-xs text-zinc-400 mt-1">Consommation en temps réel des agents KallFlow Engine, wallet et crédits télécom.</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="p-2 bg-zinc-900/80 border border-zinc-800/80 hover:border-zinc-700/80 rounded-lg text-xs text-zinc-300 transition-colors"
