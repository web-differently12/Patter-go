  ...
  return (
    <div className="space-y-6 text-slate-100 p-6 bg-[#08090a] min-h-screen font-sans">
      <div className="border-b border-zinc-800 pb-4">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-white mt-0.5">Historique des Appels et Lecteur Audio</h1>
      </div>

      <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5 shadow-xl space-y-4 text-xs">
        <div className="flex justify-between items-center border-b border-zinc-800/80 pb-3">
          <span className="font-mono text-zinc-300">Appels recents (Telephony Carrier Gateway)</span>
